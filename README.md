...
Оптимизация проводится по восьми показателям:
...
- Martin ratio;
- коэффициент Омега;
- годовая волатильность (минимизируется);
- максимальная просадка (минимизируется).

Для волатильности и максимальной просадки используется отрицательное значение исходного показателя, поэтому во всех восьми случаях большее значение целевой функции соответствует лучшему результату.
